...
*/
    ...
    ;
    var Ta = new Sa("OFF",Infinity), Ua = new Sa("WARNING",900), Va = new Sa("CONFIG",700), Wa = function() {
        this.C = 0;
        this.clear()
    }, Xa;
    ...
    var Za = function(a, b) {
        ...
        if (c)
            return c;
        c = db(a, b.slice(0, Math.max(b.lastIndexOf("."), 0)));
        var d = new Za(b,c);
        a.entries[b] = d;
        c.children.push(d);
        return d
...
*/
    ...
    function wb() {
        var a = xb;
        if (!Array.isArray(a) || !Array.isArray(a.raw) || a.length !== a.raw.length || !ub && a === a.raw || !(ub && !vb || rb(a)) || 1 !== a.length)
    ...
    function Ab(a) {
        if (a instanceof v)
            a instanceof v && a.constructor === v ? a = a.S : (Ga("expected object of type SafeUrl, got '" + a + "' of type " + ra(a)),
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    ;var N = function(a, b, c) {
      ...
      , Zb = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g
      , $b = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,"g")
      ...
      , hc = function(a, b) {
        ...
        a = new x(a,Ra);
        if (1 === e.nodeType && (b = e.tagName,
        "SCRIPT" === b || "STYLE" === b))
            throw Error("SCRIPT" === b ? "Use safeScriptEl.setTextContent with a SafeScript." : "Use safeStyleEl.setTextContent with a SafeStyleSheet.");
        a instanceof x && a.constructor === x ? a = a.R : (Ga("expected object of type SafeHtml, got '" + a + "' of type " + ra(a)),
    ...
    var kc = function(a, b, c, d) {
        if (B[c + "EventListener"])
            B[c + "EventListener"](a, b, !1);
        else if (B[d + "tachEvent"])
            B[d + "tachEvent"]("on" + a, b)
    }
      , lc = function() {
        var a = C.readyState;
      ...
      , nc = function(a) {
        if (lc())
            ...
            B.addEventListener ? (B.addEventListener("load", c, !1),
            B.addEventListener("DOMContentLoaded", c, !1)) : B.attachEvent && (B.attachEvent("onreadystatechange", function() {
    ...
    var Dc = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      , Lc = function(a, b, c, d, e) {
        ...
        try {
            ...
            if (e && 0 < e.length) {
                ...
                for (d = {}; c < e.length; ) {
                    var l = e[c++]
                      , p = ta(l) ? "o" + (Object.prototype.hasOwnProperty.call(l, ua) && l[ua] || (l[ua] = ++va)) : (typeof l).charAt(0) + l;
                    Object.prototype.hasOwnProperty.call(d, p) || (d[p] = !0,
                    e[b++] = l)
                }
                e.length = b;
                h = h + "?le=" + e.join(",");
      ...
      , Oc = function(a, b, c, d) {
        ...
        return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.V ? "/am=" + e(a.V) : "", a.ha ? "/rs=" + e(a.ha) : "", a.ja ? "/t=" + e(a.ja) : "", "/cb=", e(c)].join("")
    }
      , Mc = function(a) {
        ...
        c = 0;
        for (d = Ec.length; c < d; ++c)
            Ec[c].test(b) && S("invalid_prefix");
        c = Pc(a, "k", !0);
        d = Pc(a, "am");
        e = Pc(a, "rs");
        a = Pc(a, "t");
    ...
    var Qc = decodeURI("%73cript")
      ...
      , Tc = function() {
        var a = O.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(Rc) ? a : O.nonce = null : C.querySelector ? (a = C.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(Rc) ? O.nonce = a : O.nonce = null) : null : null
    }
      , Wc = function(a) {
        if ("loading" != C.readyState)
            Uc(a);
        else {
            var b = Tc()
              , c = "";
    ...
    var bd = function(a) {
      ...
      , T = function(a, b, c) {
        if (b && "object" === typeof b)
            for (var d in b)
                !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !dd(a[d]) && !dd(b[d]) ? T(a[d], b[d]) : b[d] && "object" === typeof b[d] ? (a[d] = dd(b[d]) ? [] : {},
                T(a[d], b[d])) : a[d] = b[d])
    }
      , ed = function(a) {
        if (a && !/^\s+$/.test(a)) {
    ...
    var ud = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//
      ...
      , wd = function() {
        ...
        a = N(b, "authuser") || null,
        null == a && (a = (a = b.match(ud)) ? a[1] : null));
        if (null == a)
            return null;
        a = String(a);
        254 < a.length && (a = null);
    ...
    var yd, zd, Ad = void 0, X = function(a) {
        try {
    ...
    }, Bd = Y(0), Cd = Y(new Date(0)), Dd = Y(!0), Ed = Y(""), Fd = Y({}), Gd = Y([]), Hd = function(a, b) {
        if (b)
        ...
        if ("undefined" !== d) {
            ...
            b = [];
            var e = Y(a);
            if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== Gd || a.constructor !== Array && a.constructor !== Object) && (e !== Fd || a.constructor !== Array && a.constructor !== Object) && e !== Ed && e !== Bd && e !== Dd && e !== Cd))
                return Hd(a.toJSON.call(a), c);
            if (null == a)
                b[b.length] = "null";
            else if (e === Bd)
                a = Number(a),
                ...
                if (e === Cd)
                    return Hd(a.toISOString.call(a), c);
                if (e === Gd && Y(a.length) === Bd) {
                    b[b.length] = "[";
                    var f = 0;
                    for (d = Number(a.length) >> 0; f < d; ++f)
                        f && (b[b.length] = ","),
                        b[b.length] = Hd(a[f], c) || "null";
                    b[b.length] = "]"
                    ...
                    d = 0;
                    for (f in a)
                        Object.prototype.hasOwnProperty.call(a, f) && (e = Hd(a[f], c),
    ...
    }, Id = /[\0-\x07\x0b\x0e-\x1f]/, Jd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/, Kd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/, Ld = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/, Md = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g, Nd = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, Od = /[ \t\n\r]+/g, Pd = /[^"]:/, Qd = /""/g, Rd = /true|false|null/g, Sd = /00/, Td = /[\{]([^0\}]|0[^:])/, Ud = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, Vd = /[^\[,:][\[\{]/, Wd = /^(\{|\}|\[|\]|,|:|0)+/, Xd = /\u2028/g, Yd = /\u2029/g, Zd = function(a) {
        a = String(a);
        if (Id.test(a) || Jd.test(a) || Kd.test(a) || Ld.test(a))
            return !1;
        var b = a.replace(Md, '""');
        b = b.replace(Nd, "0");
        b = b.replace(Od, "");
        ...
        b = b.replace(Qd, "0");
        b = b.replace(Rd, "0");
        if (Sd.test(b) || Td.test(b) || Ud.test(b) || Vd.test(b) || !b || (b = b.replace(Wd, "")))
            return !1;
        ...
        if (-1 !== zd)
            return $d(),
            Ad ? u.JSON.stringify.call(u.JSON, a) : Hd(a)
    }, ce = !Date.prototype.toISOString || "function" !== typeof Date.prototype.toISOString || "1970-01-01T00:00:00.000Z" !== (new Date(0)).toISOString(), de = function() {
    ...
    je || (ne = 1E6 * (screen.width * screen.width + screen.height),
    oe = qe(C.cookie + "|" + C.location + "|" + (new Date).getTime() + "|" + Math.random()),
    ke = W("random/maxObserveMousemove") || 0,
    0 != ke && kc("mousemove", pe, "add", "at"));
    var re = function() {
        var a = O.onl;
        if (!a) {
            a = E();
      ...
      , se = function(a, b) {
        b = b.onload;
        return "function" === typeof b ? (re().a(a, b),
        b) : null
    }
      , te = function(a) {
    ...
    var ve = {
      ...
      , ze = function(a, b, c, d, e) {
        ...
        try {
            ...
            f || (f = (a ? new Jb(Ib(a)) : Da || (Da = new Jb)).na("IFRAME"),
            g && (f.onload = function() {
                f.onload = null;
                g.call(this)
            }
        ...
        for (var h in c)
            a = c[h],
            "style" === h && "object" === typeof a ? H(a, f.style) : we[h] || f.setAttribute(h, String(a));
    ...
    var Fe = function(a) {
      ...
      , Ge = function(a) {
        ...
        for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
            ...
            if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = Fe(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i))
                return e
        }
    ...
    var He = {
      ...
      , Me = function(a, b, c) {
        ...
        c = {};
        for (var l in f)
            F(f, l) && h.test(l) && (c[l.replace(h, "")] = f[l],
            delete f[l]);
        l = "q" == U("iframes/" + a + "/params/si") ? f : c;
        h = md();
        for (var p in h)
            !F(h, p) || F(f, p) || F(c, p) || (l[p] = h[p]);
        p = [].concat(Ke);
        (l = U("iframes/" + a + "/methods")) && "object" === typeof l && Mb.test(l.push) && (p = p.concat(l));
        for (var q in b)
            F(b, q) && /^on/.test(q) && ("plus" != a || "onconnect" != q) && (p.push(q),
            delete f[q]);
        delete f.callback;
        c._methods = p.join(",");
        return fc(e, f, c)
      ...
      , Pe = function(a) {
        for (var b = E(), c = 0 != a.nodeName.toLowerCase().indexOf("g:"), d = a.attributes.length, e = 0; e < d; e++) {
            var f = a.attributes[e]
              , g = f.name
              , k = f.value;
            0 <= Nb.call(Ne, g) || c && 0 != g.indexOf("data-") || "null" === k || "specified"in f && !f.specified || (c && (g = g.substr(5)),
            b[g.toLowerCase()] = k)
        }
        a = a.style;
    ...
    var xb = fa(["data-"]), Te, Ue, Ve, We, Xe, Ye = /(?:^|\s)g-((\S)*)(?:$|\s)/, Ze = {
        plusone: !0,
        autocomplete: !0,
        profile: !0,
        signin: !0,
      ...
      , af = function(a, b, c, d) {
        ...
        for (f = 0; f < e.length; f++) {
            ...
            var h = g.nodeName.toLowerCase()
              , l = void 0;
            if (g.hasAttribute("data-gapiscan"))
                k = null;
            else {
                var p = h.indexOf("g:");
            ...
            k && (Ze[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != Vb(Pe(g)).length) && (Xb(g),
            D(c, k, []).push(g))
        }
        if (b)
            for (var q in c)
        ...
        if (cf(Xe || {}))
            for (var K in c) {
                ...
                for (b = a.length; n < b; n++)
                    a[n].removeAttribute("data-gapiscan");
                df(K)
            }
        else {
            d = [];
    ...
    var df = function(a, b) {
      ...
      , ef = function(a, b, c, d, e, f) {
        ...
        case 1:
            if (b.parentNode) {
                ...
                g = b = k;
                Ae.test(b) && (g = W("iframes/" + g.substring(1) + "/url"),
                I(!!g, "Unknown iframe url config for - " + b));
                k = hc(C, g.replace(Be, De));
                b = c.ownerDocument || C;
                h = 0;
                do
                    g = f.id || ["I", xe++, "_", (new Date).getTime()].join("");
                ...
                p = p || "";
                !p && n && (n = N(b.location.href, "_gfid", "") || N(b.location.href, "id", ""),
                p = N(b.location.href, "pfname", ""),
                p = n ? p + "/" + n : "");
                p || (n = ae(N(b.location.href, "jcp", ""))) && "object" == typeof n && (p = (p = n.id) ? n.pfname + "/" + p : "");
                q.pfname = p;
                f.connectWithJsonParam && (n = {},
                n.jcp = be(q),
                q = n);
                ...
                if (h.forcePost || q && 2E3 < k.length) {
                    ...
                    for (q = 0; q < l.length; q++)
                        n = l[q].split("=", 2),
                        f.push([decodeURIComponent(n[0]), decodeURIComponent(n[1])]);
                    h.query = [];
                    l = dc(h);
      ...
      , Re = function(a, b) {
        ...
        if (d) {
            ...
            pd.log("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
    };
    D(J, "platform", {}).go = bf;
    cf = function(a) {
        ...
        function d(f) {
            ...
            if (sf(g, b)) {
                ...
                tf(a, function() {
                    h && P("rqd");
                    c();
                    for (var l = D(O, "RPMQ", []), p = 0; p < l.length; p++)
                        l[p]({
                            data: g,
                            origin: k
                        })
    ...
    var yf = "https:" === window.location.protocol
      ...
      , Bf = function() {
        ...
        zf.iterate(function(c, d) {
            0 === c.indexOf("G_AUTHUSER_") && (c = Af(c.substring(11)),
    ...
    ;
    m.da = function() {
        this.O && (this.X() ? this.A = this.U : this.A = Math.min(2 * (this.A || this.U), 120),
        window.setTimeout(ya(this.da, this), 1E3 * this.A))
    }
    ;
    m.A = 0;
    m.U = 2;
