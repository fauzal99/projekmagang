google.maps.__gjsload__('map', function(_) {
    var Gma = function(a) {
      ...
      , Ww = function(a, b, c, d={
        ...
        const e = _.bg(d.heading)
          , f = ("hybrid" == b && !e || "terrain" == b || "roadmap" == b) && 0 != d.CB
          , g = d.hf;
        if ("satellite" == b) {
            var k;
            ...
            return new lna(k,f && 1 < _.Gk(),_.lr(d.heading),g && g.scale || null,b,e ? a.K : null,!!d.Vw,a.D)
        }
        return new _.Zv(_.jr(a.C),"Maaf, kami tidak memiliki citra di sini.",f && 1 < _.Gk(),_.lr(d.heading),c,g,d.heading,a.D,a.F)
    }
      , ona = function(a) {
        function b(c, d) {
            if (!d || !d.Ye)
      ...
      , qna = function(a, b) {
        return new Xw(pna(a),a.g,"number" === typeof b ? new _.ko(b) : a.l,"number" === typeof b ? 21 : 22,"Hibrida","Tunjukkan citra dengan nama jalan",_.Br.hybrid,"m@" + a.s,{
            type: 68,
            params: {
      ...
      , sna = function(a, b) {
        ...
        return new Xw(rna(a),null,"number" === typeof b ? new _.ko(b) : a.l,c ? 21 : 22,"Satelit","Tunjukkan citra satelit",c ? "a" : _.Br.satellite,null,null,"satellite",a.o,a.h,a.m,b,a.i)
    }
      , tna = function(a, b) {
        return c=>Ww(a, b, a.g, {
            hf: c.hf().get()
      ...
      , una = function(a, b, c={}) {
        ...
        if ("hybrid" == b) {
            ...
            b = "roadmap" == b && 1 < _.Gk() && c.XI ? new Xw(ona(a),a.g,a.l,22,"Peta","Tunjukkan peta jalan",_.Br.roadmap,"m@" + a.s,{
                type: 68,
                params: {
                    set: "Roadmap"
                }
            },"roadmap",a.o,a.h,a.m,void 0,a.i) : "terrain" == b ? new Xw(tna(a, "terrain"),a.g,a.l,21,"Medan","Tunjukkan peta jalan dengan medan",_.Br.terrain,"r@" + a.s,{
                type: 68,
                params: {
                    set: "Terrain"
                }
            },"terrain",a.o,a.h,a.m,void 0,a.i) : new Xw(tna(a, "roadmap"),a.g,a.l,22,"Peta","Tunjukkan peta jalan",_.Br.roadmap,"m@" + a.s,{
                type: 68,
                params: {
                    set: "Roadmap"
                }
      ...
      , vna = function(a, b=!1) {
        const c = _.Bj.F ? "Gunakan \u2318 + scroll untuk memperbesar atau memperkecil peta" : "Gunakan ctrl + scroll untuk memperbesar atau memperkecil peta";
        a.i.textContent = b ? c : "Gunakan dua jari untuk menggerakkan peta";
      ...
      , zna = function(a) {
        return new _.Jt([a.draggable, a.wC, a.Od],_.vm(xna, yna))
    }
      ...
      , Zw = function(a, b, c) {
        function d() {
            ...
            var t = Zw.wJ(a.getDiv());
            t.width -= e;
            t.width = Math.max(1, t.width);
            t.height -= f;
            t.height = Math.max(1, t.height);
            q = a.getProjection();
            const v = Zw.xJ(q, b, t, a.get("isFractionalZoomEnabled"));
            var x = Zw.GJ(b, q);
            if (_.bg(v) && x) {
            ...
            if (!1 !== c) {
                ...
                if ("none" !== c && ("cooperative" !== c || !d)) {
                    ...
                    d || !(16 > Math.abs(a.g))) {
                        ...
                        d ? a.fa.rz(f, b) : (c = Math.round(e.zoom + f),
                        a.i !== c && (ooa(a.fa, c, b, ()=>{
                            a.i = null
                        }
                        ),
      ...
      , voa = function(a, b, c, d=()=>"greedy", {GC: e=()=>!0, vP: f=!1, uM: g=()=>null, Bv: k=!1, Zf: m=()=>{}
    }={}) {
        k = {
            Bv: k,
      ...
      , lna = class {
        constructor(a, b, c, d, e, f, g=!1, k) {
            this.l = "Maaf, kami tidak memiliki citra di sini.";
            this.g = a || [];
    ...
    var spa = class {
        ...
        set N(a) {
            ...
            a.addEventListener("click", c=>{
                const d = c.target;
                _.bo(c) || _.Nm(c) || !this.g.has(d) || this.g.get(d).Cx(c)
            }
            )
        }
        C(a) {
    ...
    var uoa = class {
        ...
        di(a) {
            if (this.active) {
                a = this.active.FL + (a.zb.clientY - this.active.origin.clientY) / 128;
        ...
        if (q)
            if (42 !== Array.from(new Set([42]))[0])
                ...
                Promise.all([k.i, k.s]).then(([Sa,Na])=>{
                    ...
                    if (fb || Sa)
                        Jd.fc.DM = new wpa(tb,Jd,fb,Sa,$d,bx)
                }
                );
                ...
                a.g || (qb = function() {
                    ...
                    Promise.all([_.Pg("controls"), k.i, k.s]).then(([Sa,Na,fb])=>{
                        ...
                        fb = Na && (Uma(fb) || !1);
                        Sa.DK(tc, a, Ia, lc, D, A.report_map_issue, rd, Nc, t.Ti, c, k.Ne, C, qd, tb, Na, Wc, fb);
                        Sa.EK(a, t.h, lc, Wc, fb);
                        Sa.rv(c)
                    }
                    )
                }
