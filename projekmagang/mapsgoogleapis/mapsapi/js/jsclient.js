...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [["https://khms0.googleapis.com/kh?v=959\u0026hl=id\u0026", "https://khms1.googleapis.com/kh?v=959\u0026hl=id\u0026"], null, null, null, 1, "959", ["https://khms0.google.com/kh?v=959\u0026hl=id\u0026", "https://khms1.google.com/kh?v=959\u0026hl=id\u0026"]], null, null, null, null, [["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]], [["https://khms0.googleapis.com/kh?v=158\u0026hl=id\u0026", "https://khms1.googleapis.com/kh?v=158\u0026hl=id\u0026"], null, null, null, null, "158", ["https://khms0.google.com/kh?v=158\u0026hl=id\u0026", "https://khms1.google.com/kh?v=158\u0026hl=id\u0026"]], null, null, null, null, null, null, null, [["https://streetviewpixels-pa.googleapis.com/v1/thumbnail?hl=id\u0026", "https://streetviewpixels-pa.googleapis.com/v1/thumbnail?hl=id\u0026"]]], ["id", "ID", null, 0, null, null, "https://maps.gstatic.com/mapfiles/", null, "https://maps.googleapis.com", "https://maps.googleapis.com", null, "https://maps.google.com", null, "https://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", null, "https://www.google.com", 1, "https://maps.googleapis.com/maps_api_js_slo/log?hasfast=true", 0, 0], ["https://maps.googleapis.com/maps-api-v3/api/js/54/9/intl/id_ALL", "3.54.9"], [1691213330], null, "google-maps-embed", null, [35, 39, 1, 2, 3, 8, 15, 17, 18, 20, 21, 23, 26, 45, 47, 48, 88, 30, 10, 51, 63, 68, 72, 76, 85, 114, 131, 136, 112], null, null, "onApiLoad", ["geometry", "search"], null, 1, "https://khms.googleapis.com/mz?v=959\u0026", null, "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [["/maps/vt"], ["/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["/maps/vt"], "/maps/vt", 666000000, 666, 666406831], 2, 500, [null, null, null, null, "https://www.google.com/maps/preview/log204", "", "https://static.panoramio.com.storage.googleapis.com/photos/", ["https://geo0.ggpht.com/cbk", "https://geo1.ggpht.com/cbk", "https://geo2.ggpht.com/cbk", "https://geo3.ggpht.com/cbk"], "https://maps.googleapis.com/maps/api/js/GeoPhotoService.GetMetadata", "https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch", ["https://lh3.ggpht.com/", "https://lh4.ggpht.com/", "https://lh5.ggpht.com/", "https://lh6.ggpht.com/"], "https://streetviewpixels-pa.googleapis.com/v1/tile"], null, null, null, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, null, null, [], ["54.9"], 1, 0, [1], null, null, 1, 0.009999999776482582, null, [[[6, "1696811278"]]]], loadScriptTime);
    }
    ;
...
*/
    ...
    ;
    xaa = function(a) {
        a.Io === _.nc ? a = a.Sy() : a instanceof _.Ac ? (a = a.bn || "",
    ...
    ;
    Gba = function(a) {
        a.l.read().then(a.QJ.bind(a)).catch(a.Jq.bind(a))
    }
    ;
    Fe = function(a) {
        a.readyState = 4;
    ...
    _.bi = async function(a, b) {
        try {
            if (_.ai ? 0 : _.$h())
                return (await _.Pg("log")).ir.Xr(a, b)
        } catch (c) {}
        return null
    }
    ;
    ...
    ;
    Tca = function(a) {
        const b = a.shadowRoot ?? a.attachShadow(a.constructor.ov);
        Sca(b, a.constructor.kx);
        return b
    }
    ;
    Uca = function(a) {
            ...
            if (!a.N) {
                ...
                if (0 < b.size)
                    for (const [d,e] of b) {
                        b = d;
                        var c = e;
                        !0 !== c.zN || a.l.has(b) || void 0 === a[b] || a.K(b, a[b], c)
                    }
            }
            b = !1;
            c = a.l;
    ...
    lj = function(a) {
        var b = a.g
          , c = new jj;
        _.kj(a) || fj(c, {
            Aj: "Peta diinisialisasi tanpa ID Peta yang valid, sehingga Penanda Lanjutan tidak akan bisa digunakan."
        });
        b.sw = c;
        b = a.g;
        c = new jj;
    ...
    _.$da = function(a, b, c, d) {
        ...
        a = _.Pg("streetview").then(f=>_.Pg("geometry").then(g=>f.FJ(b, c || null, g.spherical.computeHeading, g.spherical.computeOffset, e, d)));
        c && a.catch(()=>{}
        );
        return a
    }
    ...
    ;
    _.F.oy = function() {
        this.K() || (this.V || this.D || this.i ? xba(this) : this.vL())
    }
    ;
    _.F.vL = function() {
        xba(this)
    ...
    _.F.Pz = function(a) {
        ...
        this.g)))
            if ("arraybuffer" === this.responseType)
                a.arrayBuffer().then(this.SJ.bind(this), this.Jq.bind(this));
                ...
                a.text().then(this.TJ.bind(this), this.Jq.bind(this))
    }
    ;
    _.F.QJ = function(a) {
        if (this.g) {
    ...
    _.Zg = class {
        constructor(a, b, c, d, e=!0) {
            ...
            this.qv && _.kh(this.instance, `${this.g}${"_added"}`)
        }
        remove() {
            if (this.instance) {
                ...
                this.qv && _.kh(this.instance, `${this.g}${"_removed"}`);
    ...
    _.nh.prototype.unbind = function(a) {
        const b = rh(this)
          , c = b[a];
        c && (c.yw && delete oh(c.Bm, c.sh)[_.mh(c.yw)],
        this[a] = this.get(a),
        b[a] = null)
    }
    ;
...
*/
    var hga = HTMLElement
      ...
      , Ql = class extends hga {
        ...
        Ca() {
            ...
            this.Fa();
            _.Li(this);
            this.constructor.Qr?.forEach(a=>a(this))
        }
        Fa() {
            const a = new Map
    ...
    _.Rl = class extends Ql {
        ...
        removeEventListener(a, b, c) {
            ...
            if (d) {
                var e = d.get(b);
                e && (Vca(c) ? e.Av = !1 : e.zv = !1,
                e.Av || e.zv || d.delete(b),
    ...
    _.Tl.Pv = function(a, b, c) {
        ...
        c[1] = t / b,
        c[2] = f / b,
        c[3] = d / b) : (q = _.Tl.HL(_.Tl.XB([a[0] - b[0], a[1] - b[1], a[2] - b[2]])),
        t = Array(4),
        _.Tl.Pv(a, q, t),
        a = Array(4),
        _.Tl.Pv(q, b, a),
    ...
    _.Tl.Iw = function(a, b, c) {
        return _.Tl.computeSignedArea([a, b, c], 1)
    }
    ;
    _.Tl.nP = function(a, b, c) {
        return Math.abs(_.Tl.Iw(a, b, c))
    }
    ;
    _.Tl.eQ = function(a, b, c) {
        return Math.sign(_.Tl.Iw(a, b, c))
    }
    ;
    var $ca = class {
        constructor(a, b, c, d) {
    ...
    var zda = class extends _.nh {
        ...
        getMapCapabilities(a=!1) {
            var b = {};
            b.isAdvancedMarkersAvailable = this.g.sw.isAvailable;
            b.isDataDrivenStylingAvailable = this.g.Rw.isAvailable;
            b = Object.freeze(b);
            a && this.log({
                Xg: "Mcmi",
                Hl: 153027
    ...
    Qj.prototype.set = function(a, b) {
        if (null != b && !(b && _.bg(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply))
            throw Error("Nilai yang diminta untuk menerapkan google.maps.MapType");
    ...
    var Wda = class extends _.nh {
        constructor(a, b) {
            ...
            if (a)
                throw _.di(b),
                Error("Menetapkan 'renderingType' peta tidak didukung. RenderingType ditentukan secara internal dan bersifat hanya baca. Jika Anda ingin membuat peta vektor, buat ID peta di Cloud Console sesuai petunjuk di https://developers.google.com/maps/documentation/javascript/vector-map");
        }
  ...
  `;
    ...
    _.ok.prototype.map_changed = function() {
        km ? km.qw(this) : _.Pg("overlay").then(a=>{
            km = a;
            a.qw(this)
        }
        )
    ...
    ;
    lm.prototype.getLogs = lm.prototype.DJ;
    _.Qga = new lm;
    var mm = null;
    _.ta(_.zk, _.nh);
    ...
    ;
    _.zk.prototype.iy = function(a, b) {
        this.i = !0;
        this.onDraw({
            gl: a,
            transformer: b
    ...
    ;
    _.zk.prototype.onDrawWrapper = _.zk.prototype.iy;
    ...
    var eea = {
        ...
        MapsNetworkErrorEndpoint: {
            ...
            aO: "FLEET_ENGINE_GET_TASK_TRACKING_INFO"
        },
